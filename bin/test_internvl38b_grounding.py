...
def parse_args():
    parser = argparse.ArgumentParser(description="Grounding with InternVL3.5-38B on SLAKE index")
    ...
    parser.add_argument("--output", type=str, default="/home/xc1490/xc1490/projects/medvqa_2025/output/grounding/internvl38b_slake.jsonl")
