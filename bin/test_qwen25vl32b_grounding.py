...
def parse_args():
    parser = argparse.ArgumentParser(description="Grounding with Qwen2.5-VL-32B-Instruct on SLAKE index")
    parser.add_argument(
        "--index",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="/home/xc1490/xc1490/projects/medvqa_2025/output/grounding/qwen25vl32b_slake.jsonl",
