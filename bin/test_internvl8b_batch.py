...
def load_model(model_path: str):
    ...
    print("Loading InternVL3.5-8B model and tokenizer...")
    try:
...
def run_evaluation(question: str, image_path: str, model, tokenizer):
    """
    Run evaluation using InternVL3.5-8B model.
    """
...
def run_dataset(
    ...
    for idx, sample in enumerate(samples):
        ...
        record = {
            ...
            "answer": answer,  # This is now the ground truth answer
        }
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Batch inference for InternVL3.5-8B on MEDVQA datasets")
    ...
    parser.add_argument("--model_path", type=str, default="OpenGVLab/InternVL3_5-8B", 
                       help="InternVL3.5-8B model path (HF or local)")
    parser.add_argument(
        "--images_root",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/xc1490/xc1490/projects/medvqa_2025/output/internvl8b",
