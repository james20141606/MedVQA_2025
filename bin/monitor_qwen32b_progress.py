#!/usr/bin/env python3
"""
Monitor Qwen 32B progress and show remaining samples
"""
...
def print_progress(progress: Dict[str, Dict[str, Any]]):
    ...
    print("\n" + "="*80)
    print("QWEN 32B PROGRESS MONITOR")
    print("="*80)
...
def main():
    output_dir = "/scratch/xc1490/projects/medvqa_2025/output/qwen25vl32b"
    ...
    try:
        while True:
            ...
            if total_remaining == 0:
                print(f"\n🎉 All Qwen 32B datasets are complete!")
                break
