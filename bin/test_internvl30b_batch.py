...
def load_model(model_path: str):
    """Load InternVL3.5-30B-A3B model and tokenizer"""
    print("Loading InternVL3.5-30B-A3B model and tokenizer...")
    try:
...
def run_evaluation(question: str, image_path: str, model, tokenizer):
    """
    Run evaluation using InternVL3.5-30B-A3B model.
    """
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Batch inference for InternVL3.5-30B-A3B on MEDVQA datasets")
    ...
    parser.add_argument("--model_path", type=str, default="OpenGVLab/InternVL3_5-30B-A3B", 
                       help="InternVL3.5-30B-A3B model path (HF or local)")
    parser.add_argument(
        "--images_root",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/home/xc1490/xc1490/projects/medvqa_2025/output/internvl30b",
